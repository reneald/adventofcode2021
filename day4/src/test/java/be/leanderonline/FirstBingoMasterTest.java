...
class FirstBingoMasterTest {
    ...
    void setUp() {
        ...
        bingo = new BingoInterpreter().createBingo(input);
    }

    @Test
    void play() throws BingoException {
        //GIVEN
        //see setUp
        ...
        //THEN
        Assertions.assertThat(result.getKey()).isEqualTo(24);
        Assertions.assertThat(result.getValue().hasWon()).isTrue();
        Assertions.assertThat(result.getValue().sumOfUnmarkedNumbers()).isEqualTo(188);
    }
}